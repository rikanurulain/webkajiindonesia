...
// Proxy Wilayah
Route::get('/proxy-wilayah/provinsi', fn() =>
    Http::get('https://www.emsifa.com/api-wilayah-indonesia/api/provinces.json')->json());
Route::get('/proxy-wilayah/kota/{id}', fn($id) =>
    Http::get("https://www.emsifa.com/api-wilayah-indonesia/api/regencies/{$id}.json")->json());
Route::get('/proxy-wilayah/kecamatan/{id}', fn($id) =>
    Http::get("https://www.emsifa.com/api-wilayah-indonesia/api/districts/{$id}.json")->json());
Route::get('/proxy-wilayah/kelurahan/{id}', fn($id) =>
    Http::get("https://www.emsifa.com/api-wilayah-indonesia/api/villages/{$id}.json")->json());
...
Route::middleware(['auth', 'trainer'])->prefix('trainer')->name('trainer.')->group(function () {
    ...
    // Program Pelatihan
    Route::post('/pelatihan/store', [TrainerController::class, 'storeProgram'])->name('pelatihan.store');
    ...
    // Profil Trainer
    Route::put('/profil/update', [TrainerController::class, 'updateProfil'])->name('profil.update');

    // Absensi
    Route::get('/kurikulum/{pelatihan}/absensi', [AbsensiController::class, 'daftarAbsensi'])->name('absensi.daftar');
    Route::get('/kurikulum/{pelatihan}/absensi/export', [AbsensiController::class, 'exportCsv'])->name('absensi.export');
});

// =====================
// KURIKULUM & MODUL (Trainer)
// =====================
