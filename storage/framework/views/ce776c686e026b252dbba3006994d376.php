        ...
        <div class="user-card" onclick="showPage('profil')">
            <div class="user-avatar">
                <?php if(auth()->user()->foto): ?>
                    <img src="<?php echo e(asset('storage/' . auth()->user()->foto)); ?>" alt="<?php echo e(auth()->user()->name); ?>">
                <?php else: ?>
...
<div class="content">
                ...
                <div class="modul-list">
                    ...
                    <div class="modul-row">
                        ...
                        <div style="display:flex;align-items:center;gap:8px;flex-shrink:0">
                            ...
                            <?php endif; ?>
                            <button class="btn-icon" onclick="editModul(<?php echo e($m->id); ?>, <?php echo e($m->kurikulum_id ?? 'null'); ?>, '<?php echo e(addslashes($m->judul)); ?>', '<?php echo e(addslashes($m->deskripsi ?? '')); ?>', '<?php echo e($m->urutan ?? $loop->iteration); ?>')" title="Edit Modul">
    ...
    <div class="page-section" id="page-profil">
        ...
        <div class="profile-form-card">
            <div class="form-row">
                <div class="form-group"><div class="form-label">Nama Lengkap</div><div class="form-static"><?php echo e(auth()->user()->name); ?></div></div>
                <div class="form-group"><div class="form-label">Email</div><div class="form-static"><?php echo e(auth()->user()->email); ?></div></div>
                <div class="form-group">
                    <div class="form-label">No. Telepon / WhatsApp</div>
                    <div class="form-static" style="display:flex;align-items:center;gap:8px">
                        <?php if(auth()->user()->phone): ?> <span style="color:#25d366">✓</span> <?php echo e(auth()->user()->phone); ?>

                        <?php else: ?> <span style="color:var(--text-muted);font-style:italic">Belum diisi</span> <?php endif; ?>
                    </div>
                </div>
                <div class="form-group"><div class="form-label">Bidang Keahlian (Opsional)</div><div class="form-static"><?php echo e($trainer->bidang ?? '-'); ?></div></div>
            </div>
            <div class="form-group">
                <div class="form-label">Bio / Tentang Saya</div>
                <div class="form-static" style="min-height:80px;line-height:1.7"><?php echo e($trainer->bio ?? 'Belum ada bio.'); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="modal">
        ...
        <form id="form-kurikulum" method="POST" enctype="multipart/form-data" action="<?php echo e(route('trainer.kurikulum.store')); ?>">
            ...
            <div class="form-group">
                ...
                <input class="form-input" type="text" name="phone" id="k-phone" value="<?php echo e(auth()->user()->phone ?? ''); ?>" placeholder="Contoh: 6281234567890">
...
<div class="modal-overlay" id="modal-modul">
    <div class="modal" style="width:520px">
        ...
        <?php endif; ?>
        <form id="form-modul" method="POST" action="<?php echo e(route('trainer.modul.store')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <select class="form-select" name="kurikulum_id" id="m-kurikulum-id" required <?php echo e(!$adaKurikulum ? 'disabled' : ''); ?>>
            ...
            <div class="form-group">
                ...
                <input class="form-input" type="number" name="urutan" id="m-urutan" placeholder="1, 2, 3..." min="1" required <?php echo e(!$adaKurikulum ? 'disabled' : ''); ?>>
            </div>
            <div class="form-group">
                <label class="form-label">Judul Modul <span style="color:var(--accent2)">*</span></label>
                <input class="form-input" type="text" name="judul" id="m-judul" placeholder="Contoh: Pengenalan Dunia UMKM" required <?php echo e(!$adaKurikulum ? 'disabled' : ''); ?>>
            </div>
            <div class="form-group">
                <label class="form-label">Deskripsi Singkat</label>
                <textarea class="form-textarea" name="deskripsi" id="m-deskripsi" rows="3" placeholder="Deskripsi singkat isi modul..." maxlength="300" <?php echo e(!$adaKurikulum ? 'disabled' : ''); ?>></textarea>
            </div>
            <?php if($adaKurikulum): ?>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="modul-submit-btn" <?php echo e(!$adaKurikulum ? 'disabled' : ''); ?> style="<?php echo e(!$adaKurikulum ? 'opacity:.5;cursor:not-allowed' : ''); ?>">
...
<div class="modal-overlay" id="modal-profil">
    <div class="modal">
        ...
        <form method="POST" action="<?php echo e(route('trainer.profil.update')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
            <div class="form-row">
                <div class="form-group"><label class="form-label">Nama Lengkap *</label><input class="form-input" type="text" name="name" value="<?php echo e(auth()->user()->name); ?>" required></div>
                <div class="form-group"><label class="form-label">Email *</label><input class="form-input" type="email" name="email" value="<?php echo e(auth()->user()->email); ?>" required></div>
                <div class="form-group"><label class="form-label">No. Telepon</label><input class="form-input" type="text" name="phone" value="<?php echo e(auth()->user()->phone ?? ''); ?>"></div>
                <div class="form-group"><label class="form-label">Bidang Keahlian</label><input class="form-input" type="text" name="bidang_keahlian" value="<?php echo e($trainer->bidang ?? ''); ?>"></div>
            </div>
            <div class="form-group"><label class="form-label">Bio</label><textarea class="form-textarea" name="bio"><?php echo e($trainer->bio ?? ''); ?></textarea></div>
            <div class="form-group">
