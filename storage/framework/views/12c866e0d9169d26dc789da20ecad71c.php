...
<section class="bg-gradient-to-br from-primary-dark via-primary to-primary- py-16 text-white">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div>
                <img 
                    src="<?php echo e(asset('storage/logo/SYNTARA.png')); ?>"
                    alt="Logo Karya Kami"
            ...
            <table class="w-full text-sm min-w-[640px]">
                ...
                <tbody>
                    ...
                    <tr class="compare-row border-b border-gray-100 last:border-0">
                        <td class="px-6 py-3.5 text-gray-700 font-medium"><?php echo e($row[0]); ?></td>
                        <td class="px-6 py-3.5 text-center text-gray-500">
                            ...
                            <?php else: ?>
                                <span class="text-xs text-gray-500"><?php echo e($row[1]); ?></span>
                            <?php endif; ?>
                        </td>
                        <td class="px-6 py-3.5 text-center bg-primary/5 border-l border-r border-primary/10">
                            ...
                            <?php elseif($row[2] === true): ?>
                                <span class="inline-flex items-center justify-center h-5 w-5 rounded-full bg-primary/20">
                                    <svg class="w-3 h-3 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                                </span>
                            <?php else: ?>
                                <span class="text-xs font-semibold text-primary"><?php echo e($row[2]); ?></span>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="grid gap-6 lg:grid-cols-3">
            ...
            <div class="pricing-card">
                ...
                <ul class="space-y-3 mb-8 flex-1">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$ok, $text]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="flex items-start gap-2.5 text-sm <?php echo e($ok ? 'text-gray-700' : 'text-gray-400'); ?>">
                        <span class="<?php echo e($ok ? 'feat-yes' : 'feat-no'); ?>"></span>
                        <?php echo e($text); ?>
            ...
            <div class="pricing-card" style="background: linear-gradient(160deg, #0f1f1a 0%, #1a3530 100%); border-color: #2d5c50; color: white;">
                ...
                <ul class="space-y-3 mb-8 flex-1">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="flex items-start justify-between mb-3">
                    <div class="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-primary/10 shrink-0">
                        <svg class="h-5 w-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($layanan['icon']); ?>"/>
                        </svg>
                    </div>
                    <?php if($layanan['badge']): ?>
                        <?php if($layanan['badge'] === 'Enterprise'): ?>
                        <span class="badge-gold"><?php echo e($layanan['badge']); ?></span>
                        <?php else: ?>
                        <span class="badge-popular"><?php echo e($layanan['badge']); ?></span>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
                <h3 class="text-base font-bold text-gray-900 mb-1.5"><?php echo e($layanan['title']); ?></h3>
                <p class="text-sm text-gray-500 leading-relaxed"><?php echo e($layanan['desc']); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<section class="bg-gray-50 py-16">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mx-auto max-w-3xl space-y-3">
            ...
            ?>
            <?php $__currentLoopData = $alur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="step-card flex items-start gap-4">
                <div class="shrink-0 flex flex-col items-center gap-1">
                    <div class="h-10 w-10 rounded-full bg-primary text-white flex items-center justify-center text-xs font-bold shadow-md shadow-primary/25"><?php echo e($item['step']); ?></div>
                    <?php if(!$loop->last): ?>
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex flex-wrap items-center gap-2 mb-1">
                        <h3 class="text-sm font-bold text-gray-900"><?php echo e($item['title']); ?></h3>
                        <span class="text-xs font-medium text-primary bg-primary/10 px-2 py-0.5 rounded-full"><?php echo e($item['durasi']); ?></span>
                    </div>
                    <p class="text-xs text-gray-400 mb-1.5">Pelaksana: <?php echo e($item['who']); ?></p>
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="syarat-item">
                <div class="shrink-0 flex h-9 w-9 items-center justify-center rounded-lg bg-primary/10">
                    <span class="text-xs font-bold text-primary"><?php echo e($s['no']); ?></span>
                </div>
                <div>
                    <p class="text-sm font-semibold text-gray-900"><?php echo e($s['title']); ?></p>
                    <p class="text-xs text-gray-500 mt-0.5 leading-relaxed"><?php echo e($s['desc']); ?></p>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div class="mx-auto max-w-3xl space-y-3" >
            ...
            <div class="step-card" x-data="{ open: false }">
                <button @click="open = !open" class="flex w-full items-center justify-between gap-4 text-left">
                    <span class="text-sm font-semibold text-gray-900"><?php echo e($faq['q']); ?></span>
...
<section id="daftar" class="bg-gradient-to-br from-primary-dark via-primary to-primary-light py-16 text-white">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="<?php echo e(route('halal-center.gratis')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\webkajiindonesia\resources\views/pages/halal-center-berbayar.blade.php ENDPATH**/ ?>