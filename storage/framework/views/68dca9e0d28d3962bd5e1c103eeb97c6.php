...
<section class="bg-gray-50 py-16">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap justify-center gap-2 mb-10">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $industri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="rounded-2xl bg-white border border-gray-100 shadow-sm p-6">
            ...
            <div class="flex flex-wrap justify-center gap-x-4 gap-y-2 text-sm text-gray-600 font-medium">
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $klien): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span class="border-r border-gray-200 pr-4 last:border-0 last:pr-0 py-0.5"><?php echo e($klien); ?></span>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    </div>
            ...
            <div class="rounded-2xl border border-gray-100 bg-gray-50 p-6">
                ...
                <ul class="space-y-2 text-sm text-gray-600">
                    ...
                    <li class="flex items-start gap-2">
                        <span class="shrink-0 text-xs font-bold text-primary/60 mt-0.5 w-5"><?php echo e(str_pad($i+1, 2, '0', STR_PAD_LEFT)); ?>.</span>
                        <?php echo e($item); ?>
...
<section class="bg-white py-16">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="halal-card <?php echo e($member['highlight'] ?? false ? 'bg-gradient-to-br from-primary/5 to-emerald-50 border-primary/30' : ''); ?>">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        <p class="text-sm font-bold text-gray-900"><?php echo e($member['name']); ?></p>
                    </div>
                </div>
                <div class="flex flex-wrap gap-1.5">
                    ...
                    <span class="text-xs font-medium text-primary bg-primary/10 px-2 py-0.5 rounded-full"><?php echo e($role); ?></span>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<section id="daftar" class="bg-gradient-to-br from-primary-dark via-primary to-primary-light py-16 text-white">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="<?php echo e(route('halal-center.berbayar')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\webkajiindonesia\resources\views/pages/halal-center-gratis.blade.php ENDPATH**/ ?>