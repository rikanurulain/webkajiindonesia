...
<div class="tab-bar">
    <button class="tab-btn <?php echo e($status === 'pending' ? 'active' : ''); ?>"
        onclick="location.href='<?php echo e(route('admin.approval.program')); ?>?status=pending&tipe=<?php echo e($tipe); ?>'">
        Pending
    ...
    <button class="tab-btn <?php echo e($status === 'approved' ? 'active' : ''); ?>"
        onclick="location.href='<?php echo e(route('admin.approval.program')); ?>?status=approved&tipe=<?php echo e($tipe); ?>'">
        Disetujui
    ...
    <button class="tab-btn <?php echo e($status === 'rejected' ? 'active' : ''); ?>"
        onclick="location.href='<?php echo e(route('admin.approval.program')); ?>?status=rejected&tipe=<?php echo e($tipe); ?>'">
        Ditolak
...
<div class="tipe-filter">
    <a href="<?php echo e(route('admin.approval.program')); ?>?status=<?php echo e($status); ?>&tipe=all"
       class="tipe-chip <?php echo e($tipe === 'all' ? 'active-all' : ''); ?>">
        📋 Semua <span class="chip-count"><?php echo e($countTipe['all']); ?></span>
    </a>
    <a href="<?php echo e(route('admin.approval.program')); ?>?status=<?php echo e($status); ?>&tipe=kurikulum"
       class="tipe-chip <?php echo e($tipe === 'kurikulum' ? 'active-kurikulum' : ''); ?>">
        📚 Kurikulum <span class="chip-count"><?php echo e($countTipe['kurikulum']); ?></span>
    </a>
    <a href="<?php echo e(route('admin.approval.program')); ?>?status=<?php echo e($status); ?>&tipe=modul"
       class="tipe-chip <?php echo e($tipe === 'modul' ? 'active-modul' : ''); ?>">
        📝 Modul <span class="chip-count"><?php echo e($countTipe['modul']); ?></span>
    </a>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\webkajiindonesia\resources\views/admin/approval-program.blade.php ENDPATH**/ ?>