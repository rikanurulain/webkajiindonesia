...
<head>
    ...
    <title><?php echo e($title ?? 'Dashboard'); ?> — Admin KAJI Indonesia</title>
...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-brand">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="brand-box">
    ...
    <div class="nav-section">
        ...
        <a href="<?php echo e(route('admin.approval.program')); ?>"
           class="nav-item <?php echo e(request()->routeIs('admin.approval.program') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
            </svg>
            Approval Program
            <?php if(($stats['pending_program'] ?? 0) > 0): ?>
                <span class="nav-badge"><?php echo e($stats['pending_program']); ?></span>
            <?php endif; ?>
        </a>

        <a href="<?php echo e(route('admin.approval.produk')); ?>"
           class="nav-item <?php echo e(request()->routeIs('admin.approval.produk') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4zM3 6h18M16 10a4 4 0 01-8 0"/>
            </svg>
            Approval UMKM
            <?php if(($stats['pending_produk'] ?? 0) > 0): ?>
                <span class="nav-badge"><?php echo e($stats['pending_produk']); ?></span>
            <?php endif; ?>
        </a>

        <a href="<?php echo e(route('admin.approval.event')); ?>"
           class="nav-item <?php echo e(request()->routeIs('admin.approval.event') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/>
                <line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>
            </svg>
            Approval Event
            <?php if(($stats['pending_event'] ?? 0) > 0): ?>
                <span class="nav-badge"><?php echo e($stats['pending_event']); ?></span>
            <?php endif; ?>
        </a>

        <a href="<?php echo e(route('admin.approval.trainer')); ?>"
            class="nav-item <?php echo e(request()->routeIs('admin.approval.trainer') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
            </svg>
            Approval Trainer
            <?php if(($stats['pending_trainer'] ?? 0) > 0): ?>
                <span class="nav-badge"><?php echo e($stats['pending_trainer']); ?></span>
            <?php endif; ?>
        </a>

        <a href="<?php echo e(route('admin.approval.mentor')); ?>"
        class="nav-item <?php echo e(request()->routeIs('admin.approval.mentor*') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
            </svg>
            Approval Mentor
            <?php if(($stats['pending_mentor'] ?? 0) > 0): ?>
                <span class="nav-badge"><?php echo e($stats['pending_mentor']); ?></span>
            <?php endif; ?>
        </a>
    </div>
    ...
    <div class="nav-section">
        ...
        <a href="<?php echo e(route('admin.pengguna')); ?>"
           class="nav-item <?php echo e(request()->routeIs('admin.pengguna*') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/>
                <path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/>
            </svg>
            Pengguna
            <?php if(($stats['total_users'] ?? 0) > 0): ?>
                <span class="nav-badge muted"><?php echo e($stats['total_users']); ?></span>
            <?php endif; ?>
        </a>
    ...
    <div class="nav-section">
        ...
        <a href="<?php echo e(route('admin.dokumentasi.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('admin.dokumentasi*') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="user-avatar">
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->profile_photo_path): ?>
                        <img src="<?php echo e(asset('storage/' . auth()->user()->profile_photo_path)); ?>" alt="avatar">
                    <?php else: ?>
    ...
    <header class="topbar">
        ...
        <div class="topbar-right">
            <div class="date-chip">
                ...
                <?php echo e(now()->locale('id')->isoFormat('dddd, D MMM YYYY')); ?>

            </div>
            <a href="<?php echo e(route('home')); ?>" class="btn btn-ghost btn-sm" target="_blank">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
</html><?php /**PATH C:\laragon\www\webkajiindonesia\resources\views/layouts/admin.blade.php ENDPATH**/ ?>