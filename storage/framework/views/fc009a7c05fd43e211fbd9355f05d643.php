...
<section class="sticky top-[65px] z-40 bg-white border-b border-gray-100 shadow-sm">
    <div class="mx-auto max-w-7xl px-4 py-3">
        <form method="GET" action="<?php echo e(route('media')); ?>" id="filter-form" class="flex flex-wrap gap-3 items-center">
            ...
            <div class="relative flex-1 min-w-[200px]">
                ...
                <input type="text" name="q" id="search-input" value="<?php echo e(request('q')); ?>"
...
<section class="mx-auto max-w-7xl px-4 py-12">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        window.__dok[<?php echo e($item->id); ?>] = {
            ...
            video_file: <?php echo json_encode($item->video_file ? asset('storage/'.$item->video_file) : null, 15, 512) ?>,
            cover_video:<?php echo json_encode($item->cover_video ? asset('storage/'.$item->cover_video) : null, 15, 512) ?>,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\webkajiindonesia\resources\views/media/index.blade.php ENDPATH**/ ?>