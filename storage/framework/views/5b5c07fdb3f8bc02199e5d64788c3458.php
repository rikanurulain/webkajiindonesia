...
<style>
    ...
    .btn-register svg { transition: transform 0.2s; }
        ...
        <form action="<?php echo e(route('register')); ?>" method="POST" novalidate>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <button type="button" class="toggle-password" onclick="togglePass('password-field', 'eye1')">
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="password" name="password_confirmation" id="confirm-field" class="form-input"
                        placeholder="Ulangi kata sandi" required>
                    <button type="button" class="toggle-password" onclick="togglePass('confirm-field', 'eye2')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\webkajiindonesia\resources\views/pages/register.blade.php ENDPATH**/ ?>