...
<div class="container">
  ...
  <form action="<?php echo e(route('dashboard.produk.update', $product->id)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-group">
      ...
      <input type="text" name="nama" class="form-input" value="<?php echo e(old('nama', $product->nama)); ?>" required placeholder="Contoh: Grosir Daster Sidoarjo">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group">
      ...
      <select name="kategori" class="form-select" required>
        <option value="Fashion" <?php echo e(old('kategori', $product->kategori) == 'Fashion' ? 'selected' : ''); ?>>Fashion</option>
        <option value="Kuliner" <?php echo e(old('kategori', $product->kategori) == 'Kuliner' ? 'selected' : ''); ?>>Kuliner</option>
        <option value="Agrobisnis" <?php echo e(old('kategori', $product->kategori) == 'Agrobisnis' ? 'selected' : ''); ?>>Agrobisnis</option>
        <option value="Kerajinan" <?php echo e(old('kategori', $product->kategori) == 'Kerajinan' ? 'selected' : ''); ?>>Kerajinan / Jasa</option>
      </select>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group">
      ...
      <textarea name="deskripsi" class="form-textarea" required placeholder="Tuliskan detail produk unggulan Anda..."><?php echo e(old('deskripsi', $product->deskripsi)); ?></textarea>
    ...
    <div class="form-group">
      ...
      <?php if($product->foto_produk): ?>
        <div class="preview-box">
          <img src="<?php echo e(asset('storage/' . $product->foto_produk)); ?>" class="preview-img" alt="Foto Saat Ini">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="btn-box">
      <a href="<?php echo e(route('dashboard-umkm')); ?>" class="btn btn-ghost">Batal</a>
...
</html><?php /**PATH C:\laragon\www\webkajiindonesia\resources\views/profile/edit-produk.blade.php ENDPATH**/ ?>