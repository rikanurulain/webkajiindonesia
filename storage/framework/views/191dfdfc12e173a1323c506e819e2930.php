...
<div onclick="window.location='<?php echo e(route('produk.show', $produk->id)); ?>'"
     ...
     data-nama="<?php echo e(strtolower($produk->nama)); ?>">
    ...
    <div class="bg-green-100 px-4 py-2">
        <h3 class="font-serif font-bold text-gray-900 text-lg text-center truncate"><?php echo e($produk->nama); ?></h3>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\webkajiindonesia\resources\views/pages/umkm-produk.blade.php ENDPATH**/ ?>