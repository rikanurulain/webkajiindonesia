...
<div class="mt-6">
    <div class="p-6 rounded-xl text-white shadow-md transition-all duration-300
        ...
        <div class="flex items-center gap-3 mb-3">
            ...
            <h4 class="font-bold text-lg leading-tight">Status UMKM: {{ $umkm->nama }}</h4>
        </div>
        <p class="text-[11px] opacity-90 mb-3">Pendaftaran usaha Anda sedang dalam peninjauan Admin.</p>
        <div class="py-1 px-3 bg-black/10 rounded border border-white/20 text-center">
