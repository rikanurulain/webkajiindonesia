...
<section class="bg-white py-16 sm:py-20" id="tentang-kami">
    <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:items-stretch">
         ...
         {{-- Kiri: Logo + Sertifikat KEMENKUMHAM --}}
            <div class="flex flex-col items-center justify-center gap-5">
                ...
                <div class="w-full rounded-xl overflow-hidden shadow-sm ring-1 ring-gray-200">
                    <img
                        src="{{ asset('storage/logo/.jpeg') }}"
                        alt="Terdaftar di KEMENKUMHAM No: IDM001176552 - 2023"
...
<section class="bg-gray-50 py-12 sm:py-16">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="rounded-2xl overflow-hidden shadow-md ring-1 ring-gray-200">
            <img
                src="{{ asset('storage/logo/LOGOKAJIKEMENKUHAM.jpeg') }}"
...
<section class="bg-gray-50 py-16 sm:py-20">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {{-- ═══════════════════════════════════════════
            PARTNER SECTION
            Desktop : 6 kolom × 3 baris = 18 logo/slide
            Mobile  : 3 kolom × 3 baris =  9 logo/slide
        ════════════════════════════════════════════════ --}}
        <div class="mt-16 border-t border-gray-200 pt-12">
            ...
            {{-- ════════════════════════════════════════
                DESKTOP SLIDER  (md ke atas)
            ════════════════════════════════════════ --}}
            <div class="mt-8 relative hidden md:block"
                x-data="{
                    active: 0,
                    total: {{ count($slidesDesktop) }},
                    autoplay: null,
                    go(i) {
                        this.active = (i + this.total) % this.total;
                        clearInterval(this.autoplay);
                ...
                <div class="overflow-hidden px-12">
                    <div class="relative" style="min-height: 220px;">
                        @foreach ($slidesDesktop as $i => $slide)
                            <div
                                x-show="active === {{ $i }}"
                                ...
                                :class="active === {{ $i }} ? 'relative' : 'absolute inset-0'"
            ...
            {{-- ════════════════════════════════════════
                MOBILE SLIDER  (di bawah md)
            ════════════════════════════════════════ --}}
            <div class="mt-8 relative block md:hidden"
                x-data="{
                    active: 0,
                    total: {{ count($slidesMobile) }},
                    autoplay: null,
                    go(i) {
                        this.active = (i + this.total) % this.total;
                        clearInterval(this.autoplay);
                ...
                <div class="overflow-hidden px-10">
                    <div class="relative" style="min-height: 280px;">
                        @foreach ($slidesMobile as $i => $slide)
                            <div
                                x-show="active === {{ $i }}"
                                x-transition:enter="transition ease-in-out duration-500"
                                x-transition:enter-start="opacity-0"
