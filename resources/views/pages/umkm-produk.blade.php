...
<div onclick="window.location='{{ route('produk.show', $produk->id) }}'"
    ...
    <div class="bg-green-100 px-4 py-2">
        <h3 class="font-serif font-bold text-gray-900 text-lg text-center truncate">{{ $produk->nama }}</h3>
    </div>

    {{-- Deskripsi: Dibuat rata/uniform dengan line-clamp --}}
